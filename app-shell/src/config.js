...
const config = {
  gcloud: {
    bucket: "fldemo-files",
    hash: "255acc9c04f31110cb08b545f4c06e27"
  },
  bcrypt: {
    saltRounds: 12
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Contact Manager <app@flatlogic.app>',
  ...
  project_uuid: '1c807b38-4228-4357-800b-5aadfb8f789b',
...
config.pexelsQuery = 'connected network of contacts';
